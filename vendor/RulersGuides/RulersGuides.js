        ...
        OpenGridDialog = function () {
            ...
            this.render = function () {
                if (dialog === null) {
                    ...
                    titleBarTxt.nodeValue = '������';
                    okBtnTxt.nodeValue = 'ȷ��';
                    cancelBtnTxt.nodeValue = 'ȡ��';
                    delBtnTxt.nodeValue = 'ɾ��';
        ...
        Menu = function () {
            ...
            this.render = function () {
                ...
                evt.attach('mousedown', menuBtn, function () {
                    ...
                    toggles.lock.txt.nodeValue = (locked === 0) ? '�������' : '�������';
                    toggles.details.txt.nodeValue = (detailsStatus === 0) ? '��ʾ��ϸ��Ϣ' : '������ϸ��Ϣ';
                    toggles.snapdom.txt.nodeValue = (snapDom === 0) ? '����Ϊ����ļ��' : 'ȡ������Ϊ����ļ��';
        ...
        SnapDialog = function () {
            ...
            this.render = function () {
                if (dialog === null) {
                    ...
                    titleBarTxt.nodeValue = '���òο��߼��';
                    xLabelTxt.nodeValue = 'X';
                    yLabelTxt.nodeValue = 'Y';
                    okBtnTxt.nodeValue = 'ȷ��';
                    resetBtnTxt.nodeValue = '����';
                    cancelBtnTxt.nodeValue = 'ȡ��';
